...
# Load Model
parser.add_argument('--load_model', type=str, default='../../Results/checkpoints/OrganaMNIST_Det_Res18_model_240322_1200_epoch_100.pth')
...
def train(args, model, optimizer, criterion, train_loader, epoch):
    ...
    if epoch==25 or epoch==50 or epoch==75 or epoch==100:
        torch.save(model.state_dict(), '../../Results/checkpoints/OrganaMNIST_Det_Res18_model_240322_1200_epoch_{}.pth'.format(epoch))
        torch.save(optimizer.state_dict(), '../../Results/checkpoints/OrganaMNIST_Det_Res18_optimizer_240322_1200_epoch_{}.pth'.format(epoch))
...
#         data = normalize(data)        
    ...
    save_image(data, 'OrganaFigures/Det/Det_orig_img_{}.png'.format(noise_std))
    save_image(noisy_img, 'OrganaFigures/Det/Det_GN_img_{}.png'.format(noise_std))
    ...
    disp.plot()
    plt.savefig('OrganaFigures/Det/Det_GN_Pred_Matrix_{}.png'.format(noise_std))
    ...
    with open('../../Results/withNoise/OrganaMNIST_Res18/OrganaMNIST_Res18_Det_GN_Results_240322_1200_{}'.format(noise_std), 'wb') as pf:
        print('saving')
...
def test_adv(args, new_model, test_loader, attack, eps):
    ...
    with open('../../Results/withAdv/OrganaMNIST_Res18/OrganaMNIST_Res18_Det_AdvAttk_Results_240322_1200_{}'.format(
        eps), 'wb') as pf:
        print('saving')
...
def main():
    ...
    wandb.init(project='OrganaMNIST-Res18-Det')
...
#     print(class_count.dtype)
    ...
    if args.testing==False:
        network = ResNet(18, Block, 1, args.output_size).to(args.devices)
        ...
        network = ResNet(18, Block, 1, args.output_size)
        ...
        if args.add_noise==True:
            ...
            network.eval()  
            test(args, network, normalize, test_loader)
            noise_std = [0.001, 0.01, 0.05, 0.1, 0.12, 0.15, 0.2, 0.3, 0.5, 0.6]
