...
# Load Model
parser.add_argument('--load_model', type=str, default='../../Results/checkpoints/DermaMNIST_Det_Res18_model_070322_1300_epoch_100.pth')
...
def train(args, model, optimizer, criterion, train_loader, epoch):
    ...
    if epoch==25 or epoch==50 or epoch==75 or epoch==100:
        torch.save(model.state_dict(), '../../Results/checkpoints/DermaMNIST_Det_Res18_model_070322_1300_epoch_{}.pth'.format(epoch))
        torch.save(optimizer.state_dict(), '../../Results/checkpoints/DermaMNIST_Det_Res18_optimizer_070322_1300_epoch_{}.pth'.format(epoch))
...
#             break
    ...
    save_image(data, 'DermaFigures/Det/Det_orig_img_{}.png'.format(noise_std))
    save_image(noisy_img, 'DermaFigures/Det/Det_GN_img_{}.png'.format(noise_std))
...
#     print('number of correct pred:', len(corrmu))
    ...
    disp.plot()
    plt.savefig('DermaFigures/Det/Det_GN_Pred_Matrix_{}.png'.format(noise_std))
    ...
    with open('../../Results/withNoise/DermaMNIST_Res18/DermaMNIST_Res18_Det_GN_Results_070322_1300_{}'.format(noise_std), 'wb') as pf:
        print('saving')
...
def test_adv(args, new_model, test_loader, attack, eps):
    ...
    with open('../../Results/withAdv/DermaMNIST_Res18/DermaMNIST_Res18_Det_AdvAttk_Results_070322_1300_{}'.format(
        eps), 'wb') as pf:
        print('saving')
...
def main():
    ...
    wandb.init(project='DermaMNIST-Res18-Det')
    ...
    if args.testing==False:
        ...
        if args.add_noise==True:
            ...
            network.eval()  
            test(args, network, normalize, test_loader)
            noise_std = [0.001, 0.01, 0.03, 0.05, 0.07, 0.1, 0.12, 0.15]
