...
parser.add_argument('--batch_size_val', type=int, default=8192, help='Batch size for validation')
parser.add_argument('--batch_size_test', type=int, default=1, help='Batch size for testing, can only be 1')
# Load Model
parser.add_argument('--load_model', type=str, default='../../Results/checkpoints/DermaMNIST_var_threshold_model_240322_1200_epoch_50.pth', help='Path to a previously trained model checkpoint')

# Learning Rate Parameters
parser.add_argument('--lr', type=float, default=0.001, help='Learning Rate') 
parser.add_argument('--wd', type=float, default=0.0001, help='Weight decay') 
parser.add_argument('--momentum', type=float, default=0.9, help='Momentum used for Optimizer')
parser.add_argument('--a', type=float, default=0.4, help='Hyperparameter for loss1')
parser.add_argument('--b', type=float, default=20, help='Hyperparameter for loss2')
parser.add_argument('--c', type=float, default=6, help='Hyperparameter for loss3')
...
class MLP(nn.Module):
    def __init__(self, args):
        ...
        self.relu = nn.ReLU()
        self.fc1 = nn.Linear(28*28*3, 1000, bias=False) 
        self.fc2 = nn.Linear(1000, 500, bias=False)
        self.fc3 = nn.Linear(500, 500, bias=False)
        self.fc4 = nn.Linear(500, 100, bias=False)
        self.fc5 = nn.Linear(100, 5, bias=False)       
        self.fc6 = nn.Linear(5, args.output_size, bias=False)
...
#         loss1 = criterion(predict, targets)
    ...
    if epoch==15 or epoch==25 or epoch==35 or epoch==50:
        torch.save(model.state_dict(), '../../Results/checkpoints/DermaMNIST_var_threshold_model_240322_1200_epoch_{}.pth'.format(epoch))
        torch.save(optimizer.state_dict(), '../../Results/checkpoints/DermaMNIST_var_threshold_optimizer_240322_1200_epoch_{}.pth'.format(epoch))
...
def main():
    ...
    wandb.init(project='DermaMNIST-VarianceThreshold')
    ...
    train_dataset = Dataset_MedMNIST(
        '/home/ahmeds57/Projects/SCenE/PytorchCode/Oct_26_2021/VDP/src/MedMNIST/DermaCSV/Train_thresh_data.csv',
        '/home/ahmeds57/Projects/SCenE/PytorchCode/Oct_26_2021/VDP/src/MedMNIST/DermaCSV/Train_thresh_imgs_array.npy',
        transform = train_transform)
    valid_dataset = Dataset_MedMNIST(
        '/home/ahmeds57/Projects/SCenE/PytorchCode/Oct_26_2021/VDP/src/MedMNIST/DermaCSV/Val_thresh_data.csv',
        '/home/ahmeds57/Projects/SCenE/PytorchCode/Oct_26_2021/VDP/src/MedMNIST/DermaCSV/Val_thresh_imgs_array.npy',
        transform = valid_transform)
    test_dataset = Dataset_MedMNIST(
        '/home/ahmeds57/Projects/SCenE/PytorchCode/Oct_26_2021/VDP/src/MedMNIST/DermaCSV/Test_thresh_data_NoNoise.csv',
        '/home/ahmeds57/Projects/SCenE/PytorchCode/Oct_26_2021/VDP/src/MedMNIST/DermaCSV/Test_thresh_imgs_array_NoNoise.npy',
