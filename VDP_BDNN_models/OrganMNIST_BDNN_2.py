...
# Load Model
parser.add_argument('--load_model', type=str, default='../../Results/checkpoints/OrganaMNIST_VDP_Res18_model_250322_1200_epoch_100.pth')

# Loss Function Parameters
parser.add_argument('--tau_conv1', type=float, default=0.003801978637647004, help='KL Weight Term') 
parser.add_argument('--tau_b2', type=float, default=0.005058521751598461, help='KL Weight Term') 
parser.add_argument('--tau_b3', type=float, default=0.0084699706189392, help='KL Weight Term') 
parser.add_argument('--tau_b4', type=float, default=0.0045445570848360725, help='KL Weight Term') 
parser.add_argument('--tau_fc', type=float, default=0.0008164698066160115, help='KL Weight Term') 
parser.add_argument('--clamp', type=float, default=1000, help='Clamping')
# Learning Rate Parameters
parser.add_argument('--lr', type=float, default=0.00727454067112954, help='Learning Rate') 
parser.add_argument('--wd', type=float, default=7.798554755584784e-06, help='Weight decay') 
...
def train(args, model, optimizer, train_loader, epoch):
    ...
    if epoch==25 or epoch==50 or epoch==75 or epoch==100 or epoch==125 or epoch==150 or epoch==175 or epoch==200:
        torch.save(model.state_dict(), '../../Results/checkpoints/OrganaMNIST_VDP_Res18_model_250322_1200_epoch_{}.pth'.format(epoch))
        torch.save(optimizer.state_dict(), '../../Results/checkpoints/OrganaMNIST_VDP_Res18_optimizer_250322_1200_epoch_{}.pth'.format(epoch))
...
def test_noise(args, model, test_loader, normalize, noise_std):
    ...
    with open('../../Results/withNoise/OrganaMNIST_Res18/OrganaMNIST_Res18_VDP_GN_Results_250322_1200_2_{}'.format(noise_std), 'wb') as pf:
        print('saving')
...
#     print('Target: ', adv_trgt)
    ...
    with open('../../Results/withAdv/OrganaMNIST_Res18/OrganaMNIST_Res18_VDP_AdvAttk_Results_250322_1200_2_{}_{}'.format(
